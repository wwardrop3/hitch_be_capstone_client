            ...
            <div className="notifications">Profile</div>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <Link to="/trip/new"><svg xmlns="http://www.w3.org/2000/svg" width="100%" fill="currentColor" className="bi bi-plus-lg" viewBox="0 0 16 16">
                        ...
                        <tr>
                            <td>
                                <Link to="/messages"> <svg xmlns="http://www.w3.org/2000/svg" width="100%" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
